...
% \item ``Programming and programming languages'' (Bachelor Course, 2nd semester, Co-Instructor 50\%) at Ruhr-Universität Bochum, 48 hours
\end{rSection}

\begin{rSection}{Supervision}
\item PhDs: Currently 2, 2 co-supervised during Post-Doctoral
\item MSc: Currently 3, 5 successfully completed
\item BSc: 4 successfully completed
...
\item ``Detecting Semantic Bugs in JavaScript Engines'' unrestricted gift from Google
Research Scholar (\$60,000 USD)
\item ``Cross-Layer Security Analysis, Testing, and Attestation for
WebAssembly'' (co-PI) funded by the Deutsche Forschungsgemeinschaft (DFG, German
Research Foundation) under Germany's Excellence Strategy - EXC 2092 CASA -
390781972 (approved from 2026 to 2029)
% \item ``DELTA: A New Paradigm for Detecting Software Divergences'' (co-PI)
% applied for the Deutsche Forschungsgemeinschaft (DFG, German Research
% Foundation) (under review, expected from 2026 to 2029)
% \item ``CONSENT: Continuous Supply chaiN Evaluation and Trust'' (PI) applied for
% the Deutsche Forschungsgemeinschaft Emmy Noether (DFG, German Research
% Foundation) (under review, expected from 2026 to 2032)
% \item ``ASSERT: Automatic Supply chain Security Enforcement and Reliability
% Testing.'' (PI) applied for the European Research Council (ERC) Starting Grant
% (under review, expected from 2027 to 2032)
...
% (under review, expected from 2027 to 2030)
% \item ``Cross-Layer Security Analysis, Testing, and Attestation for
% WebAssembly'' (Co-PI) funded by the Deutsche Forschungsgemeinschaft (DFG, German
% Research Foundation) under Germany's Excellence Strategy - EXC 2092 CASA -
% 390781972 (under review, expected from 2026 to 2029)
\end{rSection}
